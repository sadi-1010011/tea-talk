        ...
        <section className="relative h-[70vh] w-full overflow-hidden">
          ...
          <div className="relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-center items-start">
            <ScrollReveal variant="fadeDown" delay={0.1}>
              <span className="bg-primary text-background-dark px-3 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-4 inline-block">
                Limited Edition
              </span>
            </ScrollReveal>
            ...
            <ScrollReveal variant="fadeUp" delay={0.6}>
              <div className="flex flex-wrap gap-4">
                <a
                  href="#menu"
                  className="bg-primary text-background-dark px-8 py-4 rounded-lg font-bold text-base hover:bg-primary/90 transition-all flex items-center gap-2"
                >
                  Explore Menu{" "}
        ...
        <section className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="mb-20">
            ...
            >
              ...
              <ScrollRevealItem variant="zoomIn" className="md:col-span-2">
