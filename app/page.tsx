  ...
  return (
    <>
      <main>
        {/* Hero Section */}
        {/* <Aurora
          colorStops={["#aa7942", "#aa7942", "#444444"]}
          blend={0.5}
          amplitude={1.0}
          speed={1}
        /> */}
        ...
        <section className="relative overflow-hidden pt-16 pb-24 lg:pt-24 lg:pb-32 px-6 lg:px-10 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <ScrollReveal variant="fadeUp" delay={0.5}>
                <div className="flex flex-wrap gap-4 pt-4">
                  <a
                    ...
                    className="bg-primary text-background-dark px-8 py-4 rounded-xl font-bold text-base hover:scale-[1.02] transition-transform flex items-center gap-2 shadow-lg shadow-primary/20"
                  >
                  ...
                  <a
                    href="franchise#timeline"
                    className="bg-slate-200 dark:bg-primary/10 text-slate-900 dark:text-white border border-slate-300 dark:border-primary/20 px-8 py-4 rounded-xl font-bold text-base hover:bg-slate-300 dark:hover:bg-primary/20 transition-all"
                  >
                    Explore Our Story
                  </a>
                </div>
            ...
            <ScrollReveal variant="zoomIn" delay={0.3} duration={0.9}>
                ...
                <div className="group relative flex flex-col lg:flex-row items-center gap-8 lg:gap-12 bg-white dark:bg-background-dark/40 border border-slate-200 dark:border-primary/10 p-6 lg:p-8 rounded-3xl transition-all hover:border-primary/30">
                  <div className="w-full lg:w-1/2 aspect-video rounded-2xl overflow-hidden shadow-2xl">
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("outlet1.jpg")',
                      }}
                    />
                  </div>
                ...
                <div className="group relative flex flex-col lg:flex-row-reverse items-center gap-8 lg:gap-12 bg-white dark:bg-background-dark/40 border border-slate-200 dark:border-primary/10 p-6 lg:p-8 rounded-3xl transition-all hover:border-primary/30">
                  <div className="w-full lg:w-1/2 aspect-video rounded-2xl overflow-hidden shadow-2xl">
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("outlet2.jpg")',
                      }}
                    />
                  </div>
                  <div className="w-full lg:w-1/2 flex flex-col gap-4">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                      ...
                      Nilambur outlet offers the complete Tea Talk menu for those
                      on the move through the scenic hills.
                    </p>
                    <div className="flex flex-wrap gap-3 mt-2">
                      <span className="px-3 py-1 rounded-full bg-slate-200 dark:bg-white/5 text-[10px] font-bold uppercase">
                        24/7 Service
                ...
                <div className="group relative flex flex-col lg:flex-row items-center gap-8 lg:gap-12 bg-white dark:bg-background-dark/40 border border-slate-200 dark:border-primary/10 p-6 lg:p-8 rounded-3xl transition-all hover:border-primary/30">
                  <div className="w-full lg:w-1/2 aspect-video rounded-2xl overflow-hidden shadow-2xl">
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("outlet3.jpg")',
                      }}
                    />
                  </div>
                  <div className="w-full lg:w-1/2 flex flex-col gap-4">
              ...
              <div className="bg-primary/5 dark:bg-primary/5 border border-primary/20 rounded-4xl p-8 lg:p-16 overflow-hidden relative">
                ...
                <div className="relative z-10 max-w-3xl">
                  ...
                  <ScrollReveal variant="fadeUp" delay={0.4}>
                    <a
                      href="franchise#inquiry"
                      className="bg-primary text-background-dark px-10 py-5 rounded-2xl font-black text-lg hover:shadow-xl hover:shadow-primary/20 transition-all inline-block"
                    >
        ...
        <section className="py-24 px-6 lg:px-10 max-w-7xl mx-auto">
          <div className="flex flex-col gap-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              >
                <div className="rounded-3xl overflow-hidden border border-slate-200 dark:border-primary/10 shadow-2xl h-125">
                  <iframe
              ...
              <ScrollReveal variant="fadeRight" delay={0.2} duration={0.8}>
                <div className="bg-slate-100 dark:bg-white/3 p-8 lg:p-10 rounded-3xl border border-slate-200 dark:border-primary/10 flex flex-col justify-between h-full">
